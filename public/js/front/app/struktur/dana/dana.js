app.controller('modDeleteDanaDesaFront', ['$scope', 'dana_desa', '$modalInstance', 'id', function ($scope, dana_desa, $modalInstance, id) {
...
app.controller('DanaDesaFrontCtrl', ['$scope', 'dana_desa', '$modal', '$stateParams', function ($scope, dana_desa, $modal) {
...
//Cari Data
    ...
    $scope.hapus = function (id) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modDeleteDanaDesaFront',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
