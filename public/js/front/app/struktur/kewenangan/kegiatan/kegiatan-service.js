app.factory('kegiatan', ['$http', function ($http) {
    return {
        ...
        get: function (page, term) {
            return $http({
                method: 'get',
                url: '/api/v1/kewenangan-kegiatan-desa?page=' + page + '&term=' + term,
        ...
        getprogram: function (id) {
            return $http.get('/api/v1/get-list-program-desa/' + id);
        },
        ...
        store: function (inputData) {
            return $http({
                method: 'POST',
                url: '/api/v1/kewenangan-kegiatan-desa',
                headers: {'Content-Type': 'application/x-www-form-urlencoded', 'X-Requested-With': 'XMLHttpRequest'},
        ...
        show: function (_id) {
            return $http({
                method: 'get',
                url: '/api/v1/kewenangan-kegiatan-desa/' + _id,
                headers: {'Content-Type': 'application/x-www-form-urlencoded', 'X-Requested-With': 'XMLHttpRequest'}
            });
        },
        ...
        update: function (inputData) {
            return $http({
                method: 'PUT',
                url: '/api/v1/kewenangan-kegiatan-desa/' + inputData._id,
                headers: {'Content-Type': 'application/x-www-form-urlencoded', 'X-Requested-With': 'XMLHttpRequest'},
                data: $.param(inputData)
            });
        },
