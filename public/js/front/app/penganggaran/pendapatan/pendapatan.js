app.controller('modDeletePendapatan', ['$scope', 'pendapatan', '$modalInstance', 'id', function ($scope, pendapatan, $modalInstance, id) {
...
app.controller('modRealisasiPendapatan', ['$scope', 'pendapatan', '$modalInstance', 'id', 'jumlah', 'token', 'obj', function ($scope, pendapatan, $modalInstance, id, jumlah, token, obj) {

    $scope.jenismenu = "Pendapatan";
    ...
    $scope.submitData = function () {
        ...
        pendapatan.simpanpelaksanaan($scope.inputData)
            .success(function (data) {
                if (data.success == true) {
                    $scope.ok();
                } else {
...
app.controller('PendapatanCtrl', ['$scope', 'pendapatan', '$modal', '$stateParams', function ($scope, pendapatan, $modal) {
    $scope.inputData = {};
    ...
    //init get data
    pendapatan.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
...
// button add on click
    ...
    $scope.setKelompok = function () {
        ...
        pendapatan.getjenis($scope.inputData.kelompok._id)
    ...
    $scope.setJenis = function () {
        ...
        pendapatan.getobyek($scope.inputData.jenis._id)
...
// clear fill the textbox
    ...
    $scope.rka = function (id) {
        ...
        pendapatan.setrka($scope.inputData)
            .success(function (data) {
                if (data.success == true) {
                    $scope.alertset = {
                        class: 'success'
...
// submit data
    $scope.submitData = function (back) {
        ...
        if ($scope.addForm.$valid) {
            ...
            pendapatan.store($scope.inputData)
                .success(function (data) {
                    if (data.success == true) {
                        $scope.alertset = {
                            class: 'success'
...
// update data
    $scope.updateData = function () {
        ...
        if ($scope.editForm.$valid) {
            ...
            pendapatan.update($scope.inputData)
                .success(function (data) {
                    if (data.success == true) {
                        $scope.alertset = {
                            class: 'success'
...
//CLose alert
    ...
    $scope.hapus = function (id) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modDeletePendapatan',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
    ...
    $scope.pelaksanaan = function (id, jumlah, obj) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modRealisasiPendapatan',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
