...
app.controller('RKAPendapatanCtrl', ['$scope', 'rkapendapatan', '$modal', '$stateParams', function ($scope, rkapendapatan, $modal) {
    ...
    //init get data
    rkapendapatan.get($scope.main.page, $scope.main.term)
...
// get data
    ...
    $scope.rka = function (id) {
        ...
        rkapendapatan.setrka($scope.inputData)
            .success(function (data) {
    ...
    $scope.dpa = function (id) {
        ...
        $scope.inputData._token = $scope.csrf;
        rkapendapatan.setdpa($scope.inputData)
            .success(function (data) {
                if (data.success == true) {
                    $scope.alertset = {
                        class: 'success'
