...
app.controller('RKABembiayaanCtrl', ['$scope', 'rkapembiayaan', '$modal', '$stateParams', function ($scope, rkapembiayaan, $modal) {
    ...
    //init get data
    rkapembiayaan.get($scope.main.page, $scope.main.term)
...
// get data
    ...
    $scope.rka = function (id) {
        ...
        rkapembiayaan.setrka($scope.inputData)
            .success(function (data) {
    ...
    $scope.dpa = function (id) {
        ...
        $scope.inputData._token = $scope.csrf;
        rkapembiayaan.setdpa($scope.inputData)
            .success(function (data) {
                if (data.success == true) {
                    $scope.alertset = {
                        class: 'success'
