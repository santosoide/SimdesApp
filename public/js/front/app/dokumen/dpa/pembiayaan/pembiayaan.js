...
app.controller('DPAPembiayaanCtrl', ['$scope', 'dpapembiayaan', '$modal', '$stateParams', function ($scope, dpapembiayaan, $modal) {
    ...
    //init get data
    dpapembiayaan.get($scope.main.page, $scope.main.term)
...
// get data
    ...
    $scope.dpa = function (id) {
        ...
        dpapembiayaan.setdpa($scope.inputData)
            .success(function (data) {
