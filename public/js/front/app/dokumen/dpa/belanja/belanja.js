...
app.controller('DPABelanjaCtrl', ['$scope', 'dpabelanja', '$modal', '$stateParams', function ($scope, dpabelanja, $modal) {
    ...
    //init get data
    dpabelanja.get($scope.main.page, $scope.main.term)
...
// get data
    ...
    $scope.dpa = function (id) {
        ...
        dpabelanja.setdpa($scope.inputData)
            .success(function (data) {
