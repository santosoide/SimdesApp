app.controller('modDeleteKecamatan', ['$scope', 'kec', '$modalInstance', 'id', function ($scope, kec, $modalInstance, id) {
...
app.controller('KecamatanCtrl', ['$scope', 'kec', '$modal', '$stateParams', function ($scope, kec, $modal) {
    ...
    //init get data
    kec.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
    ...
    $scope.edit = function (_id) {
        ...
        kec.show(_id)
            .success(function (data) {
                ...
                $scope.inputData.kode_kec = data.kode_kec;
