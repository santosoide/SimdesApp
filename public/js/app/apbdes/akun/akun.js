app.controller('modDeleteAkun', ['$scope', 'akun', '$modalInstance', 'id', function ($scope, akun, $modalInstance, id) {
...
app.controller('AkunCtrl', ['$scope', 'akun', '$modal', '$stateParams', function ($scope, akun, $modal) {
    $scope.inputData = {};
    ...
    //init get data
    akun.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
    ...
    $scope.edit = function (_id) {
        ...
        akun.show(_id)
            .success(function (data) {
                ...
                $scope.inputData.akun = data.akun;
