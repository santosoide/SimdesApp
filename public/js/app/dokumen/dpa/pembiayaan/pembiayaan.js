app.controller('modVerifikasiDPAPembiayaan', ['$scope', 'dpa_pembiayaan', '$modalInstance', 'id', 'token', function ($scope, dpa_pembiayaan, $modalInstance, id, token) {
    ...
    $scope.ok = function () {
        ...
        dpa_pembiayaan.verifikasi($scope.param)
...
app.controller('DPAPembiayaanCtrl', ['$scope', 'dpa_pembiayaan', '$modal', '$stateParams', function ($scope, dpa_pembiayaan, $modal) {
    ...
    //init get data
    dpa_pembiayaan.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
            ...
            //result data
            $scope.dpa_pembiayaan = data.data;
