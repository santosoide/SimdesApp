app.controller('modVerifikasiDPABelanja', ['$scope', 'dpa_belanja', '$modalInstance', 'id', 'token', function ($scope, dpa_belanja, $modalInstance, id, token) {
    ...
    $scope.ok = function () {
        ...
        dpa_belanja.verifikasi($scope.param)
...
app.controller('DPABelanjaCtrl', ['$scope', 'dpa_belanja', '$modal', '$stateParams', function ($scope, dpa_belanja, $modal) {
    ...
    //init get data
    dpa_belanja.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
