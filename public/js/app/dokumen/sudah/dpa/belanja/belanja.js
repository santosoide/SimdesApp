app.controller('modSudahVerifikasiDPABelanja', ['$scope', 'sudah_dpa_belanja', '$modalInstance', 'id', 'token', function ($scope, sudah_dpa_belanja, $modalInstance, id, token) {
    ...
    $scope.ok = function () {
        ...
        sudah_dpa_belanja.verifikasi($scope.param)
...
app.controller('SudahDPABelanjaCtrl', ['$scope', 'sudah_dpa_belanja', '$modal', '$stateParams', function ($scope, sudah_dpa_belanja, $modal) {
    ...
    //init get data
    sudah_dpa_belanja.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
            ...
            //result data
            $scope.sudah_dpa_belanja = data.data;
...
//Cari Data
    ...
    $scope.verifikasi = function (id) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modSudahVerifikasiDPABelanja',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
