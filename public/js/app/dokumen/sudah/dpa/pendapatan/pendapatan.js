app.controller('modSudahVerifikasiDPAPendapatan', ['$scope', 'sudah_dpa_pendapatan', '$modalInstance', 'id', 'token', function ($scope, sudah_dpa_pendapatan, $modalInstance, id, token) {
    ...
    $scope.ok = function () {
        ...
        sudah_dpa_pendapatan.verifikasi($scope.param)
...
app.controller('SudahDPAPendapatanCtrl', ['$scope', 'sudah_dpa_pendapatan', '$modal', '$stateParams', function ($scope, sudah_dpa_pendapatan, $modal) {
    $scope.inputData = {};
    ...
    //init get data
    sudah_dpa_pendapatan.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
            ...
            //result data
            $scope.sudah_dpa_pendapatan = data.data;
...
//Cari Data
    ...
    $scope.verifikasi = function (id) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modSudahVerifikasiDPAPendapatan',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
