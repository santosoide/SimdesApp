app.controller('modDetilRPJMDesProgramSudahVerifikasi', ['$scope', 'sudah_rpjmdes_program', '$modalInstance', 'id', function ($scope, sudah_rpjmdes_program, $modalInstance, id) {
...
//Enable button
    ...
    sudah_rpjmdes_program.show($scope.id)
...
app.controller('modSudahVerifikasiRPJMDesProgram', ['$scope', 'sudah_rpjmdes_program', '$modalInstance', 'id', 'token', function ($scope, sudah_rpjmdes_program, $modalInstance, id, token) {
    ...
    $scope.ok = function () {
        ...
        sudah_rpjmdes_program.request($scope.param)
            .success(function (data) {
...
app.controller('SudahRPJMDesProgramCtrl', ['$scope', 'sudah_rpjmdes_program', '$modal', '$stateParams', function ($scope, sudah_rpjmdes_program, $modal) {
    $scope.inputData = {};
    ...
    //init get data
    sudah_rpjmdes_program.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
            ...
            //result data
            $scope.sudah_rpjmdes_program = data.data;
...
//Cari Data
    ...
    //Tampil Modal Detail RPJMDes Program
    $scope.rincian = function (id) {
        var modalInstance = $modal.open({
            templateUrl: 'modDetailProgramSudahVerifikasi.html',
            controller: 'modDetilRPJMDesProgramSudahVerifikasi',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
    ...
    $scope.verifikasi = function (id) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modSudahVerifikasiRPJMDesProgram',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
