app.controller('modDeleteSatuanHarga', ['$scope', 'satuan_harga', '$modalInstance', 'id', function ($scope, satuan_harga, $modalInstance, id) {
...
app.controller('SatuanHargaCtrl', ['$scope', 'satuan_harga', '$modal', '$stateParams', function ($scope, satuan_harga, $modal) {
    ...
    //init get data
    satuan_harga.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
    ...
    $scope.clearInput = function () {
        ...
        $scope.inputData.barang = '';
        $scope.inputData.spesifikasi = '';
        $scope.inputData.satuan = '';
        $scope.inputData.harga = '';
    };
    ...
    $scope.submitData = function (back) {
        ...
        if ($scope.addForm.$valid) {
            ...
            satuan_harga.store($scope.inputData)
                .success(function (data) {
                    if (data.success == true) {
                        $scope.alertset = {
                            class: 'success'
    ...
    $scope.edit = function (_id) {
        ...
        satuan_harga.show(_id)
            .success(function (data) {
                // fill the textbox
                $scope.inputData._id = _id;
                $scope.inputData.kode_rekening = data.kode_rekening;
                $scope.inputData.barang = data.barang;
                $scope.inputData.spesifikasi = data.spesifikasi;
                $scope.inputData.satuan = data.satuan;
                $scope.inputData.harga = data.harga;
    ...
    $scope.updateData = function () {
        ...
        if ($scope.editForm.$valid) {
            ...
            $scope.msg = '';
            $scope.inputData._token = $scope.csrf;
            satuan_harga.update($scope.inputData)
                .success(function (data) {
                    if (data.success == true) {
                        $scope.alertset = {
                            class: 'success'
    ...
    $scope.hapus = function (id) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modDeleteSatuanHarga',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
