app.controller('modDeleteKewenangan', ['$scope', 'kewenangan', '$modalInstance', 'id', function ($scope, kewenangan, $modalInstance, id) {
...
app.controller('KewenanganCtrl', ['$scope', 'kewenangan', '$modal', '$stateParams', function ($scope, kewenangan, $modal) {
    ...
    //init get data
    kewenangan.get($scope.main.page, $scope.main.term)
        .success(function (data) {
            //Hide loading
    ...
    $scope.submitData = function (back) {
        ...
        if ($scope.addForm.$valid) {
            ...
            kewenangan.store($scope.inputData)
                .success(function (data) {
                    if (data.success == true) {
                        $scope.alertset = {
                            class: 'success'
    ...
    $scope.edit = function (_id) {
        ...
        kewenangan.show(_id)
            .success(function (data) {
                ...
                $scope.inputData.kewenangan = data.kewenangan;
    ...
    $scope.updateData = function () {
        ...
        if ($scope.editForm.$valid) {
            ...
            $scope.msg = '';
            $scope.inputData._token = $scope.csrf;
            kewenangan.update($scope.inputData)
                .success(function (data) {
                    if (data.success == true) {
                        $scope.alertset = {
                            class: 'success'
    ...
    $scope.hapus = function (id) {
        ...
        var modalInstance = $modal.open({
            ...
            controller: 'modDeleteKewenangan',
            size: '',
            backdrop: 'static',
            resolve: {
                id: function () {
