...
class ProgramRepository extends AbstractRepository implements ProgramInterface
{
     ...
     */
    public function __construct(Program $program, LaraCacheInterface $cache, KegiatanInterface $kegiatan)
    {
        $this->model = $program;
        $this->cache = $cache;
    ...
    public function create(array $data)
    {
        try {
            ...
            $program->organisasi_id = $this->getOrganisasiId();
            $program->save();
